...
function generateShareText(shareLink, players, score) {
    let playerSymbols = players.map((_, i) => (i < players.length ? '🟢' : '🔴')).join(' ');
